...
extern "C" const int const_ImGuiKey_COUNT;
...
extern "C" const int const_ImGuiKey_KeysData_SIZE;
...
extern "C" const int const_ImGuiNavInput_KeyLeft;
extern "C" const int const_ImGuiNavInput_KeyRight;
extern "C" const int const_ImGuiNavInput_KeyUp;
extern "C" const int const_ImGuiNavInput_KeyDown;
