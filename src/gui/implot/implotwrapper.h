...
extern "C" const int const_ImPlotColormap_Viridis;
extern "C" const int const_ImPlotColormap_Plasma;
extern "C" const int const_ImPlotColormap_Hot;
extern "C" const int const_ImPlotColormap_Cool;
extern "C" const int const_ImPlotColormap_Jet;
extern "C" const int const_ImPlotColormap_RdBu;
extern "C" const int const_ImPlotColormap_Spectral;
extern "C" const int const_ImPlotColormap_Greys;
extern "C" const int const_ImPlotColormapScaleFlags_None;
extern "C" const int const_ImPlotColormapScaleFlags_NoLabel;
extern "C" const int const_ImPlotColormapScaleFlags_Opposite;
extern "C" const int const_ImPlotColormapScaleFlags_Invert;
