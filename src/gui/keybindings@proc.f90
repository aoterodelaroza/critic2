...
contains
  ...
  module subroutine set_default_keybindings()
    ...
    call set_bind(BIND_PASTE,ImGuiKey_V,mod_ctrl)
    ...
    call set_bind(BIND_VIEW_TOGGLE_ATOMS,ImGuiKey_1,mod_none)
    call set_bind(BIND_VIEW_TOGGLE_BONDS,ImGuiKey_2,mod_none)
    call set_bind(BIND_VIEW_CYCLE_LABELS,ImGuiKey_3,mod_none)
    call set_bind(BIND_VIEW_TOGGLE_CELL,ImGuiKey_4,mod_none)
    call set_bind(BIND_VIEW_TOGGLE_POLYHEDRA,ImGuiKey_5,mod_none)
    ...
    call set_bind(BIND_NAV_MEASURE_TOGGLE,ImGuiKey_MouseRight,mod_none)
    ...
    call set_bind(BIND_MOVEMOL_EXIT,ImGuiKey_MouseLeftDouble,mod_none)
    call set_bind(BIND_MOVEATOM_EXIT,ImGuiKey_MouseLeftDouble,mod_none)
    call set_bind(BIND_PICKATOM_EXIT,ImGuiKey_MouseLeftDouble,mod_none)
