...
module scenes
  ...
  real*8, parameter, public :: anim_speed_default = 4d0
  real*8, parameter, public :: anim_amplitude_default = 5d0
  ...
  type scene
     ...
     real*8 :: vibarrow_length = arrow_length_def ! arrow length of the largest-amplitude atom (bohr)
     type(rep_shape) :: vibarrow = rep_shape(kind=shapekind_arrow,rad=arrow_radius_def,&
        rgb=shape_rgb_def) ! style of the arrows
     ! the transient shapes object holding the arrows ((owner,tag), 0 = none);
     ! its list is regenerated by the scene build
     integer :: vibarrow_owner = 0
     integer :: vibarrow_tag = 0
     ! what the arrow list was generated from
     integer :: vibarrow_geniqpt = 0
     integer :: vibarrow_genifreq = 0
     real*8 :: vibarrow_genphase = 0d0
   ...
   contains
     ...
     procedure :: vib_amplitude => scene_vib_amplitude
     procedure :: clear_vib_mode => scene_clear_vib_mode
