...
module param
  ...
  real*8, parameter :: alpha_free(1:maxzat) = (/  0.6668D0,  0.2051D0, 24.3300D0,  5.6000D0,& ! 1-4
     ...
     18.2000D0, 17.5000D0,    -999d0,    -999d0,    -999d0,    -999d0,    -999d0,    -999d0,& ! 101-108
        ...
        -999d0,    -999d0/) / .52917720859d0**3 ! 117-118
  ...
  ! adapted from tessel.
  integer, parameter :: JMLcol(3,maxzat) = reshape((/&
     ...
     112,112,255 /),shape(JMLcol)) !< jmol color definitions

  ! jmol colors, slightly darker
  integer, parameter :: JMLcol2(3,maxzat) = reshape((/&
     ...
     052,052,195 /),shape(JMLcol2)) !< jmol color definitions, slightly darker

  ! covalent radii, from tessel
  real*8, parameter :: atmcov(maxzat) = (/&
     ...
     -999,-999,-999,-999,-999,-999,-999,-999,-999,-999/) / bohr2pm ! 109-118

  ! van der waals radii, from the CSD
  real*8, parameter :: atmvdw(maxzat) = (/&
  ...
  real*8, parameter :: atmass(maxzat) = (/&
