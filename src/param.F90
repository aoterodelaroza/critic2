...
module param
  ...
  real*8, parameter :: autofs = 2.4188843265857d-2 !< atomic unit of time to femtoseconds
  real*8, parameter :: pcamu = 1.660538782d-24 !< atomic mass unit [g] (nist2006)
  real*8, parameter :: kboltz = 3.166811563d-6 !< Boltzmann constant [hartree/K]
  real*8, parameter :: amu2au = 1822.888486209d0 !< atomic mass unit -> electron mass [a.u.]
  ...
  integer, parameter :: vcalc_vasp = 3
  integer, parameter :: vcalc_lammps = 4
  integer, parameter :: vcalc_pwmat = 5
  integer, parameter :: vcalc_crystal = 6
  integer, parameter :: vcalc_castep = 7
  integer, parameter :: vcalc_alamode = 8
  integer, parameter :: vcalc_abinit = 9
  integer, parameter :: vcalc_siesta = 10
  integer, parameter :: vcalc_abacus = 11
  integer, parameter :: vcalc_wien2k = 12
  integer, parameter :: vcalc_elk = 13
  integer, parameter :: vcalc_dftbp = 14
  ...
  real*8, parameter :: atmcov0(0:maxzat0) = (/&
     ...
     1.21d0, 1.22d0, 1.36d0, 1.43d0, 1.62d0, 1.75d0, 1.65d0, 1.57d0, 0.25d0, 0.25d0,& ! 111-120
  ...
  real*8, parameter :: atmvdw0(0:maxzat0) = (/&
      ...
      2.00d0, 2.00d0, 2.00d0, 2.00d0, 2.00d0, 2.00d0, 2.00d0, 2.00d0, 2.00d0, 2.00d0,& ! 101-110
