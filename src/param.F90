...
module param
  ...
  integer, parameter, public :: isformat_xyz = 12
  integer, parameter, public :: isformat_wfn = 13
  integer, parameter, public :: isformat_wfx = 14
  integer, parameter, public :: isformat_fchk = 15
  integer, parameter, public :: isformat_molden = 16
  integer, parameter, public :: isformat_gaussian = 17
  integer, parameter, public :: isformat_siesta = 18
  integer, parameter, public :: isformat_xsf = 19
  integer, parameter, public :: isformat_gen = 20
  integer, parameter, public :: isformat_vasp = 21
  integer, parameter, public :: isformat_pwc = 22
  ...
  integer, parameter, public :: isformat_pdb = 35
  integer, parameter, public :: isformat_zmat = 36
  ...
  real*8, parameter :: atmcov0(0:maxzat0) = (/&
     ...
     2.00d0, 1.80d0, 1.90d0, 1.87d0, 1.80d0, 1.69d0, 1.50d0, 1.50d0, 1.50d0, 1.50d0,& ! 91-100
