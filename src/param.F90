...
module param
  ...
  integer, parameter, public :: isformat_f21 = 3
  integer, parameter, public :: isformat_cube = 4
  integer, parameter, public :: isformat_bincube = 5
  integer, parameter, public :: isformat_struct = 6
  integer, parameter, public :: isformat_abinit = 7
  integer, parameter, public :: isformat_elk = 8
  integer, parameter, public :: isformat_qein = 9
  integer, parameter, public :: isformat_qeout = 10
  integer, parameter, public :: isformat_crystal = 11
  integer, parameter, public :: isformat_fploout = 12
  integer, parameter, public :: isformat_xyz = 13
  integer, parameter, public :: isformat_wfn = 14
  integer, parameter, public :: isformat_wfx = 15
  integer, parameter, public :: isformat_fchk = 16
  integer, parameter, public :: isformat_molden = 17
  integer, parameter, public :: isformat_gaussian = 18
  integer, parameter, public :: isformat_siesta = 19
  integer, parameter, public :: isformat_xsf = 20
  integer, parameter, public :: isformat_gen = 21
  integer, parameter, public :: isformat_vasp = 22
  integer, parameter, public :: isformat_pwc = 23
  integer, parameter, public :: isformat_axsf = 24
  integer, parameter, public :: isformat_dat = 25
  integer, parameter, public :: isformat_pgout = 26
  integer, parameter, public :: isformat_orca = 27
  integer, parameter, public :: isformat_dmain = 28
  integer, parameter, public :: isformat_aimsin = 29
  integer, parameter, public :: isformat_aimsout = 30
  integer, parameter, public :: isformat_tinkerfrac = 31
  integer, parameter, public :: isformat_gjf = 32
  integer, parameter, public :: isformat_castepcell = 33
  integer, parameter, public :: isformat_castepgeom = 34
