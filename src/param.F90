...
module param
  ...
  integer, parameter, public :: isformat_dat = 23
  ...
  integer, parameter, public :: ifformat_txt = 15
  ...
  integer, parameter, public :: ifformat_as_ghost_explicit = 30
  ...
  real*8, dimension(0:lmax2,0:lmax2) :: c_kub !< cubic harmonic coefficients
