...
contains
       ...
       if (.not.sy%f(fid)%grid%wan%haschk) then
          ...
          do is = 1, nspin
             do ibnd1 = 1, nbnd
                ...
                call sy%f(fid)%grid%get_qe_wnr(ibnd1,is,sy%f(fid)%grid%n,nwan(1),nwan(2),nwan(3),sy%f(fid)%grid%wan%kpt,f1)
                ...
                do ibnd2 = ibnd1, nbnd
                   ...
                   if (ibnd1 == ibnd2) then
                      ...
                      call sy%f(fid)%grid%get_qe_wnr(ibnd2,is,sy%f(fid)%grid%n,nwan(1),nwan(2),nwan(3),sy%f(fid)%grid%wan%kpt,f2)
                   endif
  ...
  function quadpack_f(x,unit,xnuc)
    ...
    real*8 :: quadpack_f(sy%npropi)

    real*8 :: xaux(3)

    xaux = xnuc + x * unit
    call sy%grdall(xaux,quadpack_f)
