...
contains
  ...
  !> the cell parameters using the Cholesky decomposition of the
  !> metric tensor.
  function car2crys_from_cellpar(aal,bbl) result(mat)
    real*8, intent(in) :: aal(3),bbl(3)
    real*8 :: mat(3,3)
  ...
  !> The eigenvectors are stored column-wise in mat.
  subroutine eigns(mat,eval,evali)
    use tools_io, only: ferror, faterr
  ...
  function matinv(m)
    ...
    real*8, intent(in) :: m(3,3) !< Input matrix
    real*8 :: matinv(3,3) !< Inverse of input

    matinv(1,1) =   m(2,2)*m(3,3) - m(2,3)*m(3,2)
    matinv(1,2) = - m(2,1)*m(3,3) + m(2,3)*m(3,1)
    matinv(1,3) =   m(2,1)*m(3,2) - m(2,2)*m(3,1)
    matinv(2,1) = - m(1,2)*m(3,3) + m(1,3)*m(3,2)
    matinv(2,2) =   m(1,1)*m(3,3) - m(1,3)*m(3,1)
    matinv(2,3) = - m(1,1)*m(3,2) + m(1,2)*m(3,1)
    matinv(3,1) =   m(1,2)*m(2,3) - m(1,3)*m(2,2)
    matinv(3,2) = - m(1,1)*m(2,3) + m(1,3)*m(2,1)
    matinv(3,3) =   m(1,1)*m(2,2) - m(1,2)*m(2,1)
...
1      continue
  ...
  subroutine select_lebedev(npts,xleb,yleb,zleb,wleb)
    use tools_io, only: ferror, faterr
    use param, only: pi
    ...
    select case(n)
    case(6)
       call LD0006(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(14)
       call LD0014(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(26)
       call LD0026(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(38)
       call LD0038(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(50)
       call LD0050(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(74)
       call LD0074(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(86)
       call LD0086(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(110)
       call LD0110(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(146)
       call LD0146(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(170)
       call LD0170(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(194)
       call LD0194(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(230)
       call LD0230(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(266)
       call LD0266(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(302)
       call LD0302(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(350)
       call LD0350(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(434)
       call LD0434(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(590)
       call LD0590(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(770)
       call LD0770(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(974)
       call LD0974(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(1202)
       call LD1202(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(1454)
       call LD1454(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(1730)
       call LD1730(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(2030)
       call LD2030(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(2354)
       call LD2354(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(2702)
       call LD2702(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(3074)
       call LD3074(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(3470)
       call LD3470(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(3890)
       call LD3890(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(4334)
       call LD4334(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(4802)
       call LD4802(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(5294)
       call LD5294(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case(5810)
       call LD5810(xleb(1:n),yleb(1:n),zleb(1:n),wleb(1:n),n)
    case default
       call ferror('select_lebedev','Wrong point number',faterr)
    end select
