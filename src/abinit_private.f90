...
contains
  ...
  subroutine hdr_io_1(fform,hdr,unitfi)
  ...
  subroutine rhoij_alloc(cplex,nlmn,nspden,nsppol,pawrhoij,typat)
    !! NAME
    !! rhoij_alloc
    !!
    !! FUNCTION
  ...
  subroutine hdr_io_2(fform,hdr,unit)
...
10  continue
  ...
  subroutine pawrhoij_alloc(pawrhoij,cplex,nspden,nspinor,nsppol,typat,lmnsize)
    implicit none
